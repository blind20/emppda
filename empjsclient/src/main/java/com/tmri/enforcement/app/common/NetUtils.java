...
public class NetUtils {
    ...
    private static ClearableCookieJar cookieJar = new PersistentCookieJar(new SetCookieCache(),
            new SharedPrefsCookiePersistor(Latte.getApplicationContext()));
    ...
    public  void postBase64DataAsynToNet(String url, Map<String,String> map, final MyNetCall myNetCall) {

        JSONObject jo = JSONObject.parseObject(JSON.toJSONString(map));
        LatteLogger.e("postBase64DataAsynToNet",jo.toString());
        RequestBody body = FormBody.create(MediaType.parse("application/json"), jo.toString());
